...
The most challenging aspect was calling OpenAI. In a prior attempt, our program could not be pushed to GitHub because the OpenAI API key was exposed. It was flagged as a "secret" by OpenAI and was disabled after we pushed it. Using the LangChain4j demo key that came from class worked because the exact string of numbers and letters was not exposed. 
